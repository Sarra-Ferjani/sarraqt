...
void jalel::on_pb_ajouter_clicked()
{
 ...
 // client c(id,nom,prenom,num,email,adresse,commande)
  ...
  {
          player->setMedia(QUrl::fromLocalFile("C:/Users/MOTEZ/OneDrive/Documents/Integration/client ajouter.mp3"));
                      player->play();
...
bool test=tmpclient.supprimer(id);
    ...
    if (test)
    {
        player->setMedia(QUrl::fromLocalFile("C:/Users/MOTEZ/OneDrive/Documents/Integration/client supprimer.mp3"));
                    player->play();
                    qDebug()<<player->errorString();
                    QThread::sleep(1);
        ui->tabetudiant->setModel(tmpclient.afficher());
...
if (test)
{
    player->setMedia(QUrl::fromLocalFile("C:/Users/MOTEZ/OneDrive/Documents/Integration/client modifier.mp3"));
                player->play();
                qDebug()<<player->errorString();
                QThread::sleep(1);
    ui->tabetudiant->setModel(tmpclient.afficher());
...
void jalel::on_trieID_clicked()
{
        ...
        player->setMedia(QUrl::fromLocalFile("C:/Users/MOTEZ/OneDrive/Documents/Integration/tri.mp3"));
                        player->play();
                        qDebug()<<player->errorString();
                        QThread::sleep(1);
...
void jalel::on_pb_ajouter_L_clicked()
{
  ...
  if (test)
     {
         player->setMedia(QUrl::fromLocalFile("C:/Users/MOTEZ/OneDrive/Documents/Integration/livraison ajouter.mp3"));
                     player->play();
                     qDebug()<<player->errorString();
                     QThread::sleep(1);
         ui->tabliv->setModel(tmplivraison.afficher());
...
void jalel::on_pb_supprimer_L_clicked()
{
 ...
 if (test)
    {
        player->setMedia(QUrl::fromLocalFile("C:/Users/MOTEZ/OneDrive/Documents/Integration/livraison supprimer.mp3"));
                    player->play();
                    qDebug()<<player->errorString();
                    QThread::sleep(1);
        ui->tabliv->setModel(tmplivraison.afficher());
...
if(test)
       {
           player->setMedia(QUrl::fromLocalFile("C:/Users/MOTEZ/OneDrive/Documents/Integration/livraison modifier.mp3"));
                       player->play();
                       qDebug()<<player->errorString();
                       QThread::sleep(1);
           ui->tabliv->setModel(tmplivraison.afficher());
